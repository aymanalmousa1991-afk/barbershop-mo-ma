...
export function PhotoGallery() {
  ...
  const fetchPhotos = async () => {
    try {
      ...
      console.error('Fout bij laden foto\'s:', err);
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-stone-600">
            Een greep uit onze kapsels en stijlen. Laat je inspireren!
          </p>
        </div>
        ...
        {photos.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-bold text-stone-500 mb-2">Nog geen foto's</h3>
            <p className="text-stone-400">Er zijn nog geen foto's toegevoegd. Kom later terug!</p>
          </div>
        ) : (
        ...
        <DialogContent className="sm:max-w-4xl p-0 bg-transparent border-0 shadow-none">
          ...
          {selectedPhoto && (
            <div className="relative">
              <img
                src={`${API_URL}/uploads/photos/${selectedPhoto.filename}`}
                alt={selectedPhoto.caption || 'Kapsel foto'}
